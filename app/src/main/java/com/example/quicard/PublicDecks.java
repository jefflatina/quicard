...
public class PublicDecks extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (inPublic){
            ...
            publicDecks.setTextAppearance(this, R.style.unclickedbutton);
            myDecks.setTextAppearance(this, R.style.clickedbutton);
            lvDecks.setAdapter(adapter);
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.tvPublicDecks:
                inPublic = true;
                publicDecks.setTextAppearance(this, R.style.clickedbutton);
                myDecks.setTextAppearance(this, R.style.unclickedbutton);
                DeckListAdapter adapter = new DeckListAdapter(isGuest,this, R.layout.deck_lv_item, allDecks);
